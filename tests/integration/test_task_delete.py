...
async def test_delete_multiple_tasks(test_client):
    ...
    tasks = [
        {"title": "Task 1", "description": "Description 1", "task_list_id": task_list_id},
        {"title": "Task 2", "description": "Description 2", "task_list_id": task_list_id},
        {"title": "Task 3", "description": "Description 3", "task_list_id": task_list_id}
    ]
